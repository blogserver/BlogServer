...
<head>
    ...
    <link href="${staticUrl}/bower_components/ztree/css/metroStyle/metroStyle.css" rel="stylesheet">
    <style type="text/css">
...
<body>
			...
			<form class="form-horizontal">
			  <div class="form-group">
				...
				<div class="col-sm-10">
				  ...
				  <input type="text" class="form-control" id="fgroupName" readonly >
				</div>
			  </div>
			  <div class="form-group">
    ...
    <script src="${staticUrl}/bower_components/ztree/js/jquery.ztree.all-3.5.min.js"></script>
    
	<!-- blog系统JS -->
	<script src="${staticUrl}/js/common.js"></script>
    <script src="${staticUrl}/js/group.js"></script>
